 ...
 *
 * Example:
 * [player, "36182159512951925", "save", "loaded"] call oda_persistence_fnc_playerSingletonSave
 *
 * Public: No
 */
...
private _clientData = ["storeInfantry", _type, _uid, _name, _playerPos, _playerDir, _loadout, _inVehicle, _alive, _selectedWeapon, _playerVariables] joinString("|");

TRACE_2("Singleton Save Prep",_type,_clientData);

private _serverReply = "oda_persistence_client" callExtension _clientData;

TRACE_1("Persistence reply from server",_serverReply);
